...
const utils = require('./utils-331822e3.js');
    ...
    render() {
        ...
        const flipRtl = this.flipRtl ||
            (this.ariaLabel &&
                ...
                this.flipRtl !== false);
        return (core.h(core.Host, { role: "img", class: Object.assign(Object.assign({ [mode]: true }, createColorClasses(this.color)), { [`icon-${this.size}`]: !!this.size, 'flip-rtl': !!flipRtl && this.el.ownerDocument.dir === 'rtl' }) },  this.svgContent ? (core.h("div", { class: "icon-inner", innerHTML: this.svgContent, style: { "height": "100%" } })) : (core.h("div", { class: "icon-inner" }))));
    }
