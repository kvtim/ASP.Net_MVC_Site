import { r as registerInstance, h, H as Host, c as getElement } from './core-f572c876.js';
import { i as isStr, g as getUrl, b as getName } from './utils-8b8f88b8.js';
    ...
    Icon.prototype.render = function () {
        ...
        var flipRtl = this.flipRtl ||
            (this.ariaLabel &&
                ...
                this.flipRtl !== false);
        return (h(Host, { role: "img", class: Object.assign(Object.assign((_a = {}, _a[mode] = true, _a), createColorClasses(this.color)), (_b = {}, _b["icon-" + this.size] = !!this.size, _b['flip-rtl'] = !!flipRtl && this.el.ownerDocument.dir === 'rtl', _b)) }, this.svgContent ? (h("div", { class: "icon-inner", innerHTML: this.svgContent, style: { "height": "100%" } })) : (h("div", { class: "icon-inner" }))));
    };
